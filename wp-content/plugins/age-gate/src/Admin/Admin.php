...
class Admin
{
    ...
    public function notices()
    {
        ...
        // if (wp_remote_retrieve_response_code($req) !== 200 && current_user_can(Constants::RESTRICTIONS)) {
        //     echo '<div id="message" class="notice notice-error"><p>' . esc_html__('Age Gate is having trouble contacting the Wordpress REST API. Is something blocking it?', 'age-gate') . '</p></div>';
        // }
